      ...
      <section className="py-16 bg-[#050814]">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-br from-red-900/20 to-yellow-900/20 border border-red-500/30 rounded-2xl p-8 max-w-4xl mx-auto"
          >
            <div className="flex items-start gap-4">
              <AlertTriangle className="size-12 text-red-400 flex-shrink-0" />
              <div>
